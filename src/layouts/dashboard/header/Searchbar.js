    ...
    <ClickAwayListener onClickAway={handleClose}>
      <div className='flex-1'>
        {!open && (
          <div
            onClick={handleOpen}
            className="text-[#8c90a1] flex items-center rounded-lg border border-[#2f3543] p-[10px_16px]"
          >
            <Iconify icon="eva:search-fill" sx={{ color: '#8c90a1' }} />
            <div className="ml-2 flex-1 max-w-[270px]">Search</div>
          </div>
        )}
